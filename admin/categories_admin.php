...
<body>
    <div class="container-fluid">
        <div class="shadow-sm mt-0 text-center" style="height: 50px; font-size:20;"><b>CATEGORIES
                PANEL</b> </div>
...
$sql1="select * from `categories_of_dish` where `categories_name`='$categories_name'";
...
Category Already Exist!
    ...
    $sql="insert into `categories_of_dish` (`categories_name`) values ('$categories_name')";
