...
$sql="select * from `coupon_code` where `coupon_slno`='$update_id'";
...
?>
                <form action="<?php $_SERVER['REQUEST_URI'] ?>"  method="post"  class="m-3">
                    ...
                    <div class="form-group">
                        <input type="text" name="c_name" value="<?php echo $row['coupon_name']  ?>" class="form-control" placeholder="Coupon Name" id="">
                    ...
                    <div class="form-group">
                        <input type="number" name="c_price" value="<?php echo $row['coupon_price']  ?>" class="form-control" placeholder="Coupon Price" id="">
                    </div>


                    <div class="form-group">

                        <input type="date" name="c_exp_date" value="<?php echo $row['coupon_expire_date']  ?>" class="form-control" placeholder="Coupon Expire Date"
                            id="">
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $sql="update  `coupon_code` set `coupon_name`='$c_name',`coupon_price`='$c_price',`coupon_expire_date`='$c_exp_date'";
    $result=mysqli_query($conn,$sql);
