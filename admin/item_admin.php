            ...
            <div class="card-body border my-4">
                ...
                <form action="<?php $_SERVER['REQUEST_URI'] ?>" method="post" enctype="multipart/form-data" class="m-2">
                    <div class="form-group">
                        <input type="text" name="pro_name" placeholder="Product Name" class="form-control" id="">

                    </div>
                    <div class="form-group">
                       <textarea name="product_desp" id="" class="form-control" placeholder="Product Description" style="width: 100%; height:200px;"></textarea>
...
?>
                    ...
                    <div class="form-group">
                        <input type="number" name="pro_price_full" placeholder="Product Price Full" class="form-control"
                            id="">

                    </div>

                    <div class="form-group">
                        <input type="number" name="pro_price_half" placeholder="Product Price Half" class="form-control"
                            id="">

                    </div>
                    <div class="form-group">
                        <input type="text" name="pro_discount" placeholder="Product Discount" class="form-control"
                            id="">
                    ...
                    <div class="form-group">
                        <button type="submit" class=" form-control button_color">ADD ITEM</button>
...
$action=0;
    ...
    $dist='../Product Image/'.$image1;
    move_uploaded_file($image1_tmp,$dist);

    $dist1='../Product Image/'.$image2;
    move_uploaded_file($image2_tmp,$dist1);


    $dist2='../Product Image/'.$image3;
    move_uploaded_file($image3_tmp,$dist2);


    $dist3='../Product Image/'.$image4;
    move_uploaded_file($image4_tmp,$dist3);


    $sql="insert into `product_list` (`product_name`,`product_desp`,`product_categories`,`product_full_price`,`product_half_price`,`product_discount`,`product_image1`,`product_image2`,`product_image3`,`product_image4`,`action`) values ('$pro_name', '$pro_desp','$pro_categories','$pro_price_full','$pro_price_half','$pro_discount','$image1','$image2','$image3','$image4','$action')";
